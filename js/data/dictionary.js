 ...
 * bigrams for the advanced psychological difficulty toggle.
 */
...
export const awkwardSameFinger = [
  'minimum', 'classic', 'unzipped', 'plaza', 'excel', 'excess',
  'scales', 'mixed', 'mimic', 'civic', 'vivid', 'cave',
  'valid', 'alpha', 'arch', 'marsh', 'flash', 'flask',
  'glad', 'glass', 'clam', 'calm', 'clad', 'cask',
  'asks', 'lads', 'falls', 'sadly', 'daddy', 'sassy',
  'asses', 'daffs', 'gag', 'dad', 'sad', 'lad',
  'fall', 'glad', 'flash', 'flask', 'glad', 'glass',
  'asks', 'task', 'last', 'fast', 'vast', 'master',
  'craft', 'draft', 'grasp', 'stand', 'stark', 'crack',
  'track', 'black', 'flack', 'slack', 'stack', 'smack'
];
